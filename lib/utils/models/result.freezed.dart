...
mixin _$Result<T> {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(String message, dynamic error, StackTrace? stack)
        failure,
  }) =>
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(String message, dynamic error, StackTrace? stack)?
        failure,
  }) =>
      throw _privateConstructorUsedError;
  @optionalTypeArgs
  TResult maybeWhen<TResult extends Object?>({
    ...
    TResult Function(T? oldResult)? loading,
    TResult Function(T result)? success,
    TResult Function(String message, dynamic error, StackTrace? stack)? failure,
...
abstract class _$$FailureImplCopyWith<T, $Res> {
  ...
  @useResult
  $Res call({String message, dynamic error, StackTrace? stack});
}
...
class _$FailureImpl<T> extends _Failure<T> {
  const _$FailureImpl(this.message, {this.error, this.stack}) : super._();
  ...
  @override
  String toString() {
    return 'Result<$T>.failure(message: $message, error: $error, stack: $stack)';
  }
  ...
  int get hashCode => Object.hash(
      runtimeType, message, const DeepCollectionEquality().hash(error), stack);
  ...
  TResult when<TResult extends Object?>({
    ...
    return failure(message, error, stack);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    return failure?.call(message, error, stack);
  }
...
abstract class _Failure<T> extends Result<T> {
  const factory _Failure(final String message,
      {final dynamic error, final StackTrace? stack}) = _$FailureImpl<T>;
